...
faq:
  - q: "Why does my broker show two separate rows for a Bull Put Spread?"
    a: "Most brokers track each options contract as an independent position record. Your short put shows as a negative quantity and your long put as positive — each with its own cost basis, market value, and P&L. There is no combined total shown."
  - q: "How do I calculate the total P&L of a Bull Put Spread on my broker?"
    a: "Add the P&L from both rows together: short put P&L + long put P&L = total BPS P&L. Alternatively: net credit received at open minus current cost to close. On a trade where you collected $100 and it now costs $40 to close, your profit is $60 — 60% of maximum."
  - q: "Why does my Sell Put row show a large loss even when my BPS is profitable?"
    a: "The short leg shows a loss when the put you sold has risen in value — but this is always partially offset by the long put also losing value. Looking at one row alone always misleads. Only the sum of both rows tells the truth."
  - q: "How does BPS Tracker simplify options P&L tracking?"
    a: "BPS Tracker combines both legs into one number — showing opened credit, current value, profit percentage, and DTE in a single line. You enter the trade once and track it in real time without manual addition."
