...
We spent several months backtesting the Bull Put Spread strategy using Alpaca historical options data. The dataset spans February 2024 through January 2026 — roughly 20 months, 846 completed trades.
...
> **Data caveat**: Alpaca historical options data only goes back to February 2024, limiting our backtest window. These results should be treated as short-term evidence, not long-term proof. High-volatility regimes (VIX > 25) were nearly absent during this period — those results are statistically thin.
