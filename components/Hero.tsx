...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[auto] sm:min-h-screen flex items-center overflow-hidden pt-20 pb-10 sm:pb-0">
      {/* Background Effects */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-20">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
          ...
          <div className="relative flex items-center justify-center h-[280px] sm:h-[500px] lg:h-[600px] mt-8 sm:mt-0 overflow-hidden">
            {/* Screenshot 1 - Back Left (hidden on mobile) */}
            <motion.div
              initial={{ opacity: 0, x: -50, rotate: -15 }}
              animate={{ opacity: 1, x: 0, rotate: -8 }}
              transition={{ duration: 0.8, delay: 0.5 }}
              className="hidden sm:block absolute left-0 top-1/2 -translate-y-1/2 w-[200px] sm:w-[240px] z-10"
            >
              <motion.div
                animate={{ y: [0, -10, 0] }}
            ...
            <motion.div
              ...
              className="relative sm:absolute sm:left-1/2 sm:-translate-x-1/2 sm:top-1/2 sm:-translate-y-1/2 w-[160px] sm:w-[280px] max-h-[260px] sm:max-h-none z-20"
            >
              <motion.div
                animate={{ y: [0, -15, 0] }}
                ...
                className="relative"
              >
                <div className="absolute -inset-4 sm:-inset-6 bg-[var(--accent-primary)] opacity-30 blur-2xl sm:blur-3xl rounded-3xl" />
                <div className="relative rounded-[28px] sm:rounded-[36px] overflow-hidden border-2 border-[var(--border-accent)] shadow-2xl">
                  <Image
            ...
            {/* Screenshot 3 - Back Right (hidden on mobile) */}
            <motion.div
              initial={{ opacity: 0, x: 50, rotate: 15 }}
              animate={{ opacity: 1, x: 0, rotate: 8 }}
              transition={{ duration: 0.8, delay: 0.7 }}
              className="hidden sm:block absolute right-0 top-1/2 -translate-y-1/2 w-[200px] sm:w-[240px] z-10"
            >
              <motion.div
                animate={{ y: [0, -8, 0] }}
